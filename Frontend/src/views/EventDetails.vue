<template>
  ...
  <div class="pt-20 flex flex-col gap-[var(--spacing-between-sections)] w-full">
    ...
    <div class="flex flex-col gap-[var(--spacing-in-sections)]">
      ...
      <Text>
        This event offers a unique opportunity to connect, learn, and grow. Whether you're here to gain new insights, meet like-minded individuals, or explore something new, this experience is designed to inspire and engage. Everyone is welcome — come as you are and take part in something meaningful. (This needs to be replaced by the actual event description.)
      </Text>
      <Text>
