...
```
cd existing_repo
git remote add origin https://gitlab.cs.oslomet.no/jasch6198/aigenie.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cs.oslomet.no/jasch6198/aigenie/-/settings/integrations)
